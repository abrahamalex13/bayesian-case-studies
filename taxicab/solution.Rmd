...
From two alternative definitions of probability--event frequency over repeated trials, or "strength of belief" in one event's possible outcomes--follow two statistical frameworks. The former "frequentist" philosophy estimates probability of data conditional on some hypothesis. The latter "Bayesian" philosophy expands scope, and estimates probability of both data and hypothesis.^[For more on how the philosophies assign probability to data and hypotheses, a helpful resource: https://ocw.mit.edu/courses/18-05-introduction-to-probability-and-statistics-spring-2014/76926c6068c8b18e6ecb48d649b15bfd_MIT18_05S14_Reading20.pdf.]. We can see the two methods' first principles with an example problem: how many taxicabs are in an unfamiliar city?

To reproduce my calculations, check out my [R code](https://github.com/abrahamalex13/bayesian-case-studies/blob/main/taxicab/main.R).
