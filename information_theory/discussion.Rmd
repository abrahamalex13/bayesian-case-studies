...
KL Divergence's meaning connects to our primary question: 
how much does one probability distribution differ (drift) from a baseline distribution? 
If _among the no-data-drift feasible values_,
a more extreme statistic is rarely seen,
