...
How might an autonomous data analysis system detect _data drift_: shifts in data distribution? Depending on context, shifting data distributions may imply new opportunities for fast action, or new risks to be mitigated. This post proposes an automated drift detection method, tailored for categorical data.
...
Check out my code implementation [here](https://github.com/abrahamalex13/bayesian-case-studies/tree/main/information_theory).
